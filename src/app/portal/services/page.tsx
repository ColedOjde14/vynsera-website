...
'use client'; // ← This makes the whole page a client component so we can use state & onClick
...
// Define the shape of each service (prevents VS Code type errors)
interface Service {
  id: number;
  status: string;
...
export default async function ClientServices() {
  ...
  // Cast to typed array (VS Code happy)
  const assignedServices: Service[] = assignedServicesRaw as Service[];
